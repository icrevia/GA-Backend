...
from models import user, tournament, wallet, support, withdraw_upi_account, promo, banner, restriction, otp_phone_lock, user_activity_lock, admin_access_session, config, daily_stats, pending_otp
...
def _status_payload_from_config(config_map: dict[str, str]) -> dict[str, object]:
    ...
    return {
        ...
        "ludo_challenge_fee_percent": _as_int(config_map.get("LUDO_CHALLENGE_FEE_PERCENT"), 10),
    }
    ...
    async with engine.begin() as conn:
        ...
        try:
            ...
            queries = [
                ...
                "ALTER TABLE quiz_questions ADD COLUMN IF NOT EXISTS \"order\" INTEGER DEFAULT 0",
