...
def upgrade() -> None:
    ...
    if 'chat_sessions' not in inspector.get_table_names():
        ...
        sa.Column('attended_at', sa.DateTime(), autoincrement=False, nullable=True),
        ...
        sa.Column('blocked_at', sa.DateTime(), autoincrement=False, nullable=True),
        ...
        sa.Column('ended_at', sa.DateTime(), autoincrement=False, nullable=True),
    ...
    if 'chat_messages' not in inspector.get_table_names():
        ...
        sa.Column('media_expires_at', sa.DateTime(), autoincrement=False, nullable=True),
    ...
    op.alter_column('tournament_participants', 'team_join_code',
               ...
               type_=sa.String(),
               existing_nullable=True)
    op.execute("DROP INDEX IF EXISTS ix_tp_team_join_code")
    op.execute("DROP INDEX IF EXISTS uq_tournament_participant_slot_idx")
    op.create_index(op.f('ix_tournament_participants_team_join_code'), 'tournament_participants', ['team_join_code'], unique=False)
    op.execute("DROP INDEX IF EXISTS ix_tournaments_status_match_time")
